...
2021 年，我们做了星空问答。当时的判断是：这件事可以做十年。做了一年多，没做起来。这里想讲另一件事：怎么收场。
...
独立开发者皮特·莱维尔斯（Pieter Levels）公开说过，他做了 70 多个项目，能算做成的只有 4 个，成功率不到 5%。OpenClaw 的作者彼得·斯坦伯格（Peter Steinberger）在做出这个全球爆红的项目之前，也做过 43 个项目。
...
前些天，同事问创新项目什么样算失败该止损。我说，如果 Owner 认为失败了，或者虽然不认为失败但是没有好主意了，就该进入低功耗运行。

反过来说，什么情况下可以继续？我觉得有三个条件。

第一，你有足够的资源打仗。现金越充沛，你越有底气。哪怕项目暂时不挣钱，哪怕是为了情怀，只要账上的钱还够撑，你就有继续的本钱。钱是最基础的前提，没有钱，其他条件都不成立。

第二，项目的负责人还没放弃。他对这件事还有热情，脑子里还在不断冒出新主意来改进产品。不是在应付，不是在硬撑，而是真心实意地在想怎么做得更好。一个项目最核心的驱动力，就是那个对它最有责任感的人。他还在燃烧，这件事就还有希望。

第三，反馈还在。反馈分两种：一种是用户直接告诉你的，比如访谈、聊天、客服记录；另一种是用户的行为数据，比如他每天用几次，每次用多久，是主动打开还是推送才来。前者告诉你用户怎么想，后者告诉你用户怎么做。两种都要看。如果用户嘴上说好但打开一次就再也不来，或者数据上活跃但访谈时说不出哪里好，都值得警惕。最好的信号是两者一致：用户说离不开，数据也证明他离不开。

这三个条件，钱是地基，人是引擎，反馈是方向盘。三个都在，就还能开下去。缺一个，就该认真想想了。
...
2005 年，乔布斯（Steve Jobs）在斯坦福大学毕业典礼上做了一次演讲，讲了三个故事，其中一个关于失败。

他 30 岁那年，被赶出了自己一手创建的苹果。他和沃兹尼亚克（Steve Wozniak）在车库里创办这家公司，花了十年把它做成一家 20 亿美元的企业。然后董事会站在了他请来的 CEO 那边，把他赶走了。他说，那是一次几近毁灭的打击，他甚至想过彻底离开硅谷。
