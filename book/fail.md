...
第一，你有足够的钱打仗。哪怕项目暂时不挣钱，哪怕是为了情怀，只要账上的钱还够撑，你就有继续的本钱。钱是最基础的前提，没有钱，其他条件都不成立。

第二，项目的负责人还有热情。脑子里还在冒新主意，还在想怎么改产品，还在琢磨哪个细节可以做得更好。不是在应付，不是在硬撑，是真的在燃烧。一个项目最核心的驱动力，就是那个对它最有责任感的人。他在，他还热情，项目就还在。

第三，反馈还在。反馈分两种：用户说的，和用户做的。前者是访谈、聊天、客服记录；后者是行为数据——每天用几次，每次用多久，主动打开还是推送才来。两种都要看。如果嘴上说好但打开一次就再也不来，或者数据上活跃但访谈时说不出哪里好，都值得警惕。最好的信号是两者一致：用户说离不开，数据也证明他离不开。

三个条件都在，继续。缺一个，认真想想。缺两个，该做个了断。
