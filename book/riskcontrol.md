...
有短视频平台的做法是：爆火视频至少经过四级人工审核，每层审核关注不同维度并逐级严格。

**风控引擎**

风控引擎是整个风控体系的大脑。它的核心能力是实时决策——在毫秒内判断一个行为是放行、拦截还是转人工。

早期的风控引擎主要靠人工配置规则。AI 时代，模型的判断力越来越强，能从海量行为数据中识别出人写不出规则的异常模式。规则和模型配合使用：规则处理已知的、确定的风险，模型捕捉未知的、模糊的风险。根据不同场景灵活组合，做出最终决策。
...
对大平台而言，审核这件事挺痛的——高峰时期内容审核团队曾经超过万人。非核心部门预算低，审核员成本、培训成本、离职率都很高。国际化业务不懂多国审核标准，中小公司对舆情反应慢。工作成果难量化。
...
企业的内容安全至少包括三个层面：产品业务中用户发布的内容、公司官方对外发布的内容（公众号、微博、视频号）、公司员工以个人身份发布的社交媒体内容。
