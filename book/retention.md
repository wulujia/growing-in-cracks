...
更好的做法是找到产品的核心动作。知识星球的核心动作是“阅读帖子”；读书产品是“阅读时长超过 5 分钟”；外卖平台是“下单”。

定义活跃时，要结合产品的自然使用频率。外卖可能每天用，记账软件可能每周用，旅行预订可能每月用。用每日留存去衡量一个月用一次的产品，没有意义。

定义好活跃之后，下一个问题是：怎么把用户分类，才能找到提升留存的杠杆？
...
为什么？因为当前用户有个特点：他今天来了，明天还来，后天还来，他就一直待在“当前用户”这个桶里。这是复利。每天的改进都会叠加到下一天。时间越长，效果越明显。

新用户不一样。新用户今天来，明天不管来不来，他都不再是新用户了。新用户留存率再高，也只影响他一次。但当前用户留存率高，影响的是他接下来的每一天。

想通这一点，多邻国做了个重大决定：不再把主要精力放在新用户激活上，转而成立专门的留存团队，北极星指标就是 CURR。
...
这些看起来都是小改动。但因为它们都在提升 CURR，效果会层层叠加：留存率上去了，DAU 就涨；DAU 涨了，数据就多；数据多了，洞察就准；洞察准了，产品就更好；产品更好，留存又上去了。这是一个增强循环。

四年后，连续打卡 7 天以上的用户，从不到四分之一，涨到了超过一半。CURR 提升了 21%。流失率下降了 40%。DAU 增长了 4.5 倍。

### 知识星球的实践：连胜功能

看到多邻国的成功，我们也想在知识星球做类似的事。下面是一个真实的内部提案和讨论过程。

这个提案不是一次就通过的。雏形在 v4.59 版本的需求牌桌首次提出，当时缺少数据支撑，被否了。后来团队参考多邻国的案例，调整了几个版本，才通过了牌桌。
...
目标：让 CURR 中的 B 类用户（7日1-2活）往 A 类（7日3活）迁移，稳住 A 类用户的流失率。
...
功能设计包括：入口、连胜达成提醒、连胜日历、星友连胜榜、通知与召回（图 22-2）。

![](img/retention-02.png)

图 22-2 连胜功能设计稿

**结论**

先验证用户对连胜是否有感觉，先做入口和排行榜，看数据再做其他。当作实验来推进，定好阶段性目标，推行一段时间后看是否达到目标，再判断接下来回退还是进一步优化。
...
注：以上是粗糙举例，实际数据在分析的过程中，会根据时间趋势和用户个体差异来精细计算。
...
第二，先验证假设。我的反馈是“先做入口和排行榜，看数据再做其他”。不是一口气把所有功能做完，而是用最小成本验证核心假设：用户对连胜是否有感觉。
...
但在知识星球的场景里，我们调整了计算方式：

- 我们在 Redash 看板上以天为单位监测数据，但图表上的每个时间点不只反映当天。
- 每个时间点看的是：这类用户在过去 7 天活跃了几天，其中有多少人上一周也活跃过。这个比例就是我们定义的 CURR。

我们把用户分成两类：7日3活（过去七天至少活跃三天）和7日1-2活（过去七天只活跃一到两天）。

7日3活用户里，约 93% 上一周也活跃过，说明这批用户黏性很强。剩下的 7% 是新增或沉默回流的用户，占比很小。

7日1-2活用户就不一样了，只有大约一半上周活跃过，另一半是新增或回流用户。这说明这批用户根基不稳，随时可能流失。

为什么不直接用多邻国的计算方式（上周活跃的用户中，本周活跃的比率是多少）？

两个原因：

- 我们按天统计，能更及时地看到日活变化，而不用等一整周的数据。
- 这种算法能看清 7日3活 的用户里，有多少是上周就活跃的“真留存”。如果出现热点事件或拉新活动带来一波新用户，CURR 会立即反映出来（通常是下降），不会被短期数据虚高误导。
...
这个发现直接指导了产品迭代。我们开始在各种地方提醒星主：该更新了，该回复成员了，该发起一次讨论了。就是在帮星主提升他们的 CURR。
...
Pinterest 让用户创建画板，收藏喜欢的图片。用了一段时间后，用户积累了几十个画板、上千张图片。这时候让他换一个产品？太难了，那些心血都在这里。
...
数据涨的时候没人着急，一步步来就行。涨不动了，心态就变了。团队开始琢磨大动作：加个重磅功能，搞一次大改版，找一个突破口撬开天花板。越急越想出奇制胜，越容易翻车。

产品是有边界的。真正被团队做砸的大产品不多。更常见的是：团队急了，拼命往外撑——加功能、改方向、拓品类。结果原来的核心没守住，新的方向也没站稳。这种拔苗助长的事，很多产品都干过。
...
村上春树说过：必须确保那个喜欢这里的人是真的喜欢。为此，要让自己的理念和态度足够鲜明，并且无论如何都要耐心地坚持下去。