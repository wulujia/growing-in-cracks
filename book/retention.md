...
多邻国是一款语言学习 App，2019 年时增长遇到瓶颈。他们做了一件事：把所有用户分成七个桶，每个用户每天只能在一个桶里（图 23-1）。

![图 23-1 多邻国的用户增长模型](img/retention-01.png)
...
功能设计包括：入口、连胜达成提醒、连胜日历、星友连胜榜、通知与召回（图 23-2）。

![图 23-2 连胜功能设计稿](img/retention-02.png)

**牌桌讨论**

wlj：先验证用户对连胜是否有感觉，先做入口、排行榜，看数据再做其他标识等地方的拓展。
