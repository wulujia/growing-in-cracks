...
从小密圈的 Slogan 变迁，可以看出定位变化的历程（图 22-1）：
...
![图 22-1 Slogan 演变：寻找产品定位](img/nonlinear-02.png)
...
![图 22-2 非线性增长：慢慢地，然后突然地](img/nonlinear-01.png)
...
- 维护期：低功耗。市场没有明显机会，团队需要休整。养精蓄锐比盲目消耗更重要（图 22-3）。

![图 22-3 产品阶段与节奏策略](img/nonlinear-03.png)
