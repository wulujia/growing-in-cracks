...
做产品二十年，很多问题的答案不是更多的人、更多的钱，是换一个角度想。
...
DeepSeek 的创始人梁文锋在采访中说过，钱不是问题，芯片禁令才是。怎么办？用更聪明的算法弥补硬件的不足。

2025 年 1 月，R1 模型发布。多项测试中达到甚至超过 OpenAI 的 ChatGPT o1。训练成本 560 万美元，OpenAI 训练 GPT-4 花了超过 1 亿美元。

马克·安德森（Marc Andreessen）说：”DeepSeek R1 是我见过的最惊人的突破之一——作为开源项目，这是给世界的一份厚礼。”

这个突破怎么来的？MLA 架构的创新来自一个年轻研究员的好奇心——他分析了注意力架构的演变，有了一个新想法。团队花几个月，把想法变成了现实。

团队几乎全是国内培养的人才，没有海归。如果追求短期目标，找有经验的人更直接。但长远来看，基础能力、创造力和热情比经验更关键。

组织方式完全自下而上，很少自上而下分配任务。面对颠覆性技术，闭源系统的护城河是短暂的。真正的护城河是团队在过程中成长，积累 know-how，形成有创新能力的文化。

创新不完全由商业驱动，还需要好奇心和创造欲。
...
平时晚上九十点钟公司就没人了，那天却很有意思。没什么人指挥，大家各自分工：研究部几个人分析蠕虫特征，TK 写了一个全自动清除蠕虫并修复漏洞的脚本，小海把它改写成图形界面的专杀工具，当时我在工程部，干不了需要太多研究和编码的活儿，好歹把发给用户的公告、邮件内容备好了。
...
公司利益和客户利益冲突的时候，站客户那边。说起来容易，真到了要掏钱的时候，才知道是不是真的。
...
我们说的简单，不是少做。是把复杂想透了，找到那个关键点，再把多余的全部拿掉。这比做加法难得多。
...
第一个是产品的简单。苹果的设计团队向乔布斯（Steve Jobs）展示 iDVD 的设计方案。iDVD 是一款让用户把音乐、电影、照片刻录到 DVD 的软件。设计师们很骄傲：界面漂亮、功能清晰，比起需要一千页用户手册的旧版本，已经大大简化了。

乔布斯走到白板前，画了一个方框。他说：“这就是新应用。用户把视频拖进来，点一个按钮，叫'刻录'。结束。”

乔尼·艾维（Jony Ive）后来解释苹果的简单哲学：“简单不是视觉风格，不是极简主义。要真正简单，你必须深刻理解产品的本质，才能去掉那些不必要的部分。”
...
第三个是流程的简单。马斯克（Elon Musk）有一套”五步工作法”：
...
前面四条价值观，例子都来自知识星球。但价值观跟着人走，不只在一个产品里。

我参与的另一个产品"敲敲打卡"做过一个小尝试（图 33-2）。敲敲和腾讯公益合作了一个"小花捐赠"的功能。用户完成一周四次打卡，得到一朵小红花，可以选择在本周捐出。敲敲团队会进行配捐，比如捐出两万块钱，通过腾讯公益平台捐给选定的公益项目。

![](img/value-02.png)

图 33-2 敲敲打卡的小花捐赠

为什么做这个功能？一方面是这个团队热心公益，希望能做一些小事帮到各种各样的公益组织，所以我们联系了腾讯公益。另一方面，我们相信每周的努力坚持是有价值的。敲敲的 slogan 是"敲敲成为更好的自己"，如果这份坚持不只让自己变好，还能让更多人受益，那就特别好。

前期配捐的钱都是团队自己出的，花了不少。但因为我们相信这件事，花得心甘情愿。

长远来看，我们希望让更多组织参与进来。比如一家小企业在敲敲上发起一个习惯，用户打卡时企业做相应的配捐。对企业有宣传价值，对社会也有贡献。

这就是这个产品、这群人的价值观在产品中的体现。不是写在墙上的，是真的愿意为它花钱。

## 决策

小团队的决策，常见两种病：一是老板一言堂，二是民主投票。前者快但容易错，后者慢且容易变成政治。

Manus 的创始人季逸超分享过一个决策框架，叫 GPA 模型：
...
我们团队也有类似的感受。很多时候讨论到最后，不是达成了共识，是做了一个实验。结果出来，共识自然就有了。

## 迭代

价值观不是一成不变的教条。随着公司发展，可以也应该根据实践效果持续改进。

HubSpot 创始人达梅什·沙阿（Dharmesh Shah）说：文化就像代码，需要不断根据反馈调试修复 bug、发布新版本。他们的文化手册已经更新到第 41 版。2013 年，他们发现原有的 HEART 框架缺了“Empathy”（共情）这一价值，果断把“E”由“Effective”改为“Empathetic”。
